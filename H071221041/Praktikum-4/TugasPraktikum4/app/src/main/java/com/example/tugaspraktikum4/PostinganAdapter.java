...
import com.example.tugaspraktikum4.ProfileActivity;
import com.example.tugaspraktikum4.fragment.ProfileFragment;
...
public class PostinganAdapter extends RecyclerView.Adapter<PostinganAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            IVFeed = itemView.findViewById(R.id.IV_Postingan);
            ivProfile = itemView.findViewById(R.id.menu_profile);
