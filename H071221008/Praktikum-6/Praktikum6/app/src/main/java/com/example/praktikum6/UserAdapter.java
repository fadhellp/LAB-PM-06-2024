...
// Metode ini bertanggung jawab untuk membuat instance baru dari UserViewHolder yang digunakan untuk menampilkan item pengguna
...
// menghubungkan data dari objek user ke viewholder yg stiap item discroll  dlm tmpilan metode ini akan
    // dipanggil untuk mengatur data yang sesuai ke ViewHolder yang sesuai dengan posisinya dalam RecyclerView
    public void onBindViewHolder(@NonNull UserViewHolder holder, int
            position) {
        User user = userList.get(position);
        holder.bind(user);
    }
// mengembalikan jumlah total item dalam daftar pengguna
